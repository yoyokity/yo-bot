...
export class Pathlib {
     ...
     */
    searchFiles (dirPath: string, extensions: string[] = [], recursive = false): string[] {
        const allFiles: any[] = []
        ...
        function traverseDir (currentDir: any) {
     ...
     */
    async moveFile (sourceFile: string, targetPath = '', newFileName = '', isCopy = false): Promise<void> {
        //检查原路径
